...
function Testimonial() {
    useEffect(() => {
        const swiper = new Swiper('.mySwiper', {
            ...
            navigation: {
                nextEl: '.swiper-button-next', // Check if these selectors are correct
                prevEl: '.swiper-button-prev', // Check if these selectors are correct
            },
            effect: 'slide', // Specify the sliding animation effect
            breakpoints: {
                640: {
                    slidesPerView: 1,
                    spaceBetween: 32,
        ...
        return () => {
            swiper.destroy(); // Cleanup function to destroy Swiper instance
        };
                    ...
                    <div className="swiper-wrapper w-max">
                        <div className="swiper-slide">
                            <div className="group  text-gray-300  hover:brightness-90 transition-all cursor-pointer group bg-gradient-to-tl from-gray-900 to-gray-950 hover:from-gray-800 hover:to-gray-950 border-r-2 border-t-2 border-gray-900 m-4 rounded-xl p-6 w-full mx-auto overflow-hidden relative">
                                ...
                                <div className="flex items-center gap-5 border-t border-solid border-gray-200 pt-5">
                                    ...
                                    <div className="block">
                                        <h5 className="text-gray-300 font-medium transition-all duration-500 mb-1">Jane D</h5>
                                    </div>
                                </div>
                        ...
                        <div className="swiper-slide">
                            <div className="group  text-gray-300  hover:brightness-90 transition-all cursor-pointer group bg-gradient-to-tl from-gray-900 to-gray-950 hover:from-gray-800 hover:to-gray-950 border-r-2 border-t-2 border-gray-900 m-4 rounded-xl p-6 w-full mx-auto overflow-hidden relative">
                                ...
                                <div className="flex items-center gap-5 pt-5 border-t border-solid border-gray-200">
                                    ...
                                    <div className="block">
                                        <h5 className="text-gray-300 font-medium transition-all duration-500  mb-1">Harsh P.</h5>
                                    </div>
                                </div>
                                <div className="h-2 w-full bg-gradient-to-l via-yellow-500 group-hover:blur-xl blur-2xl m-auto rounded transition-all absolute bottom-0"></div>
                                <div className="group-hover:w-full bg-gradient-to-l via-yellow-950 group-hover:via-yellow-500 w-[70%] m-auto rounded transition-all"></div>
                        ...
                        <div className="swiper-slide">
                            <div className=" group  text-gray-300  hover:brightness-90 transition-all cursor-pointer group bg-gradient-to-tl from-gray-900 to-gray-950 hover:from-gray-800 hover:to-gray-950 border-r-2 border-t-2 border-gray-900 m-4 rounded-xl p-6 w-full mx-auto overflow-hidden relative">
                                <div className="">
                                    ...
                                    <p className="text-base text-gray-400 leading-6 transition-all duration-500 pb-8 group-hover:text-gray-300 slide_active:text-gray-400">
                                        The customer service team at pagedone went above and beyond to help me resolve a greater billing issue.
                                    </p>
                                </div>
                                <div className="flex items-center gap-5 border-t border-solid border-gray-200 pt-5">
                                    <img className="h-10 w-10" src="	https://pagedone.io/asset/uploads/1696230027.png" alt="avatar" />
                                    <div className="block">
                                        <h5 className="text-gray-300 font-medium transition-all duration-500  mb-1">Alex K.</h5>
                                    </div>
                                </div>
                                <div className="h-2 w-full bg-gradient-to-l via-yellow-500 group-hover:blur-xl blur-2xl m-auto rounded transition-all absolute bottom-0"></div>
                                <div className="group-hover:w-full bg-gradient-to-l via-yellow-950 group-hover:via-yellow-500 w-[70%] m-auto rounded transition-all"></div>
                        ...
                        <div className="swiper-slide">
                            <div className="group  text-gray-300  hover:brightness-90 transition-all cursor-pointer group bg-gradient-to-tl from-gray-900 to-gray-950 hover:from-gray-800 hover:to-gray-950 border-r-2 border-t-2 border-gray-900 m-4 rounded-xl p-6 w-full mx-auto overflow-hidden relative ">
                                ...
                                <div className="h-2 w-full bg-gradient-to-l via-yellow-500 group-hover:blur-xl blur-2xl m-auto rounded transition-all absolute bottom-0"></div>
                                <div className=" group-hover:w-full bg-gradient-to-l via-yellow-950 group-hover:via-yellow-500 w-[80%]  m-auto rounded transition-all"></div>
                            </div>
                        </div>
