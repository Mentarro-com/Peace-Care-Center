    ...
    <div className="flex justify-center items-center flex-wrap mb-4 mt-9">
      ...
      <div className="w-full md:w-1/2 p-4 md:p-8">
        ...
        <p className="text-lg mb-4">
          Welcome to our sanctuary of healing and renewal, where hope finds its home and lives are transformed. At Peace Life Care Center, we're dedicated to guiding individuals towards a brighter, healthier tomorrow through a holistic approach to rehabilitation.
        </p>
