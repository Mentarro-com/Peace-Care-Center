...
const App = () => {
  ...
  const services = [
    ...
    { name: "Psychiatric Treatment Center", description: "Peace Life Care Centre in Pozhichalur, Chennai specializes in treating a variety of mental health challenges exacerbated by urbanization, job stress, and lifestyle changes.They offer a holistic approach including counselling, medication, and lifestyle interventions aimed at promoting long-term behavioral changes and preventing illnesses like anxiety and depression.The centre's psychiatric clinicians provide compassionate, multidisciplinary care known for its excellence in therapies and procedures tailored to each patient's needs..", image: img4 },
  ...
  const info = [
    ...
    <Info1 key="4" text="Peace Life Care Centre in Pozhichalur, Chennai specializes in treating a variety of mental health challenges exacerbated by urbanization, job stress, and lifestyle changes.*They offer a holistic approach including counselling, medication, and lifestyle interventions aimed at promoting long-term behavioral changes and preventing illnesses like anxiety and depression.*The centre's psychiatric clinicians provide compassionate, multidisciplinary care known for its excellence in therapies and procedures tailored to each patient's needs." isMobile={isMobile} />,
